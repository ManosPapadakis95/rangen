...
Rcpp::NumericVector rfrechet(size_t n, double shape = 1.0, double mu = 0.0, double scale = 1.0) {
    return rangen::rfrechet<Rcpp::NumericVector>(n, shape, mu, scale);
}
...
//[[Rcpp::export(name = "Sample", signature = {x, size, replace = FALSE})]]
